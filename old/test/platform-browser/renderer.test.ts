...
import { type Renderer2, RendererFactory2, RendererStyleFlags2 } from "@/core/render/renderer.ts";
...
function bootRenderer(): Renderer2 {
  ...
  const factory = injector.get<RendererFactory2>(RendererFactory2.$name);
  return factory.createRenderer(host, null);
}
