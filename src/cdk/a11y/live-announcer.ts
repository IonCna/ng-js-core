...
export class LiveAnnouncer {
  ...
  private readonly defaultOptions: LiveAnnouncerDefaultOptions;

  constructor(@Optional() @Inject(LIVE_ANNOUNCER_DEFAULT_OPTIONS) defaultOptions: LiveAnnouncerDefaultOptions | null) {
