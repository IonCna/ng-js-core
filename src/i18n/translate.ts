...
/** Se provee solo en la raíz; necesita `TranslateModule` (que carga `angular-translate`) importado en la app. */
@Injectable({ providedIn: "root", useClass: forwardRef(() => TranslateServiceImpl) })
...
export class TranslateServiceImpl extends TranslateService {
  ...
  constructor(
    @Inject("$translate") private readonly $translate: NgTranslateService,
