...
import { LocationStrategy } from "@/platform-browser/location/location-strategy.ts";
import type { LocationChangeEvent } from "@/platform-browser/location/platform-location.ts";
import { joinWithSlash, normalizeQueryParams, stripTrailingSlash } from "@/platform-browser/location/util.ts";
