...
/** `*ngTemplateOutlet` — atributo con binding nativo (`<`), no depende de `viewChild`/`$postLink`: cada cambio de `ngTemplateOutlet` destruye la vista anterior y crea una nueva. */
