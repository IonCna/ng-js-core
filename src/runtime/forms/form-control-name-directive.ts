...
import { findAncestorControl } from "@/runtime/forms/control-container.ts";
...
export class FormControlNameDirective {
  static readonly $inject = ["$element", "$scope", "$parse"];
  ...
  static $factory(): angular.IDirective {
    return {
      controller: FormControlNameDirective,
      restrict: "A",
      bindToController: { formControlName: "@" },
    };
  }
}
